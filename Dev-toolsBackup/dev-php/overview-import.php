...
if(file_exists('../../Import/php/restrict-access.php')) {
	...
	$table_top_query = "SELECT `COLUMN_NAME` FROM `INFORMATION_SCHEMA`.`COLUMNS` WHERE `TABLE_SCHEMA`='abicheck' AND `TABLE_NAME`='" . $table_name . "';";
	$table_top_result = mysqli_query($conn, $table_top_query);

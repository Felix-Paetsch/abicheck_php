...
<style type="text/css">
	...
	<?php
		//GET_STYLE
		$style_query = "SELECT übungen_style FROM articles WHERE article_name = '" . $_GET['article_name'] . "';";
...
<?php
	$get_ex_query = 'SELECT ex_aufgabe, ex_sol, ex_id FROM exercises WHERE article_name = "'. $_GET['article_name'] .'"';
	$ex_ex = mysqli_query($conn, $get_ex_query);
...
<div class="ex-top-row">
	<div><?php echo $content_link_array[0]; ?></div>

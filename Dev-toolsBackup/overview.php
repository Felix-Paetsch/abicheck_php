...
<?php
	$tablesquery = "SELECT INFORMATION_SCHEMA.TABLES.TABLE_NAME, INFORMATION_SCHEMA.TABLES.TABLE_ROWS FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'abicheck'";
	$tables = mysqli_query($conn, $tablesquery);

	while ($table = mysqli_fetch_assoc($tables)){
		if(isset($_GET['display'])){ if ($_GET['display'] == $table['TABLE_NAME']){echo '<option value="' . $table['TABLE_NAME'] . '" selected="selected">' . $table['TABLE_NAME'] . '</option>';
		} else {echo '<option value="' . $table['TABLE_NAME'] . '">' . $table['TABLE_NAME'] . '</option>';}
		} else 
...
<?php
	if(isset($_GET['display'])){
		include_once 'dev-php/overview-import.php';
	}
?>
	</div>
